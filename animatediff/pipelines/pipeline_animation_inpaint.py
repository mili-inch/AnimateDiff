...
@dataclass
class AnimationInpaintPipelineOutput(BaseOutput):
    videos: Union[torch.Tensor, np.ndarray]


class AnimationInpaintPipeline(DiffusionPipeline):
    ...
    def __call__(
        ...
        keyframes: Dict[int, Union[torch.FloatTensor, PIL.Image.Image]],
        video_length: Optional[int],
        height: Optional[int] = None,
        width: Optional[int] = None,
        add_predicted_noise: Optional[bool] = False,
        do_reconstruction_guidance: Optional[bool] = False,
        reconstruction_guidance_scale: Optional[float] = 2.0,
        ...
        **kwargs,
            ...
            for i, t in enumerate(timesteps):
                ...
                with torch.enable_grad():
                    ...
                    if do_reconstruction_guidance:
                        ...
                        print(initial_latents.grad)
                        latents = latents - alpha_t * reconstruction_guidance_scale / 2 * initial_latents.grad * ( 1 - mask )
                        # reset the gradient
        ...
        return AnimationInpaintPipelineOutput(videos=video)
